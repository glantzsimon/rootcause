...
namespace K9.WebApplication.Services
{
    public class MailChimpService : BaseService, IMailChimpService
    {
        ...
        public MailChimpService(IServiceBasePackage packge, IOptions<MailChimpConfiguration> mailChimpConfig, IClientService clientService)
            : base(packge)
        {
        ...
        {
            foreach (var contact in _clientService.ListClients())
            {
